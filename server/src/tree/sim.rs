...
pub fn make_test_tree(num_exts: usize, num_groups: usize, num_devices: usize) -> DeviceTree {
    ...
    let mut groups = Arena::new(num_groups.max(50).saturating_sub(1), 0);
    ...
    let mut devices = Arena::new(num_devices.max(200).saturating_sub(1), 0);
    ...
    DeviceTree {
        ...
        ext_ref_lut,
        devices,
        devices_writer: PersistWriter::fake(),
        groups_writer: PersistWriter::fake(),
    }
}
