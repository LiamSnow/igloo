    ...
    unsafe {
      ...
      unsafe impl<'a> _Subtask for _MySubtask<'a> {
        ...
        unsafe fn call_import(&mut self, _params: Self::ParamsLower, _results: *mut u8) -> u32 {
          ...
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "igloo:lib/extension-mp-to-igloo@0.1.0")]
          unsafe extern "C" {
            #[link_name = "[async-lower]id"]
...
#[allow(async_fn_in_trait)]
pub async fn register_entity(id: EntityId,) -> Entity{
  unsafe {
    ...
    *mut u8, usize, 
    ...
    unsafe impl<'a> _Subtask for _MySubtask<'a> {
      ...
      unsafe fn call_import(&mut self, _params: Self::ParamsLower, _results: *mut u8) -> u32 {
        ...
        #[link(wasm_import_module = "igloo:lib/extension-mp-to-igloo@0.1.0")]
        unsafe extern "C" {
          #[link_name = "[async-lower]register-entity"]
          fn call(_: *mut u8, _: usize, _: *mut u8, ) -> i32;
        }
  ...
  unsafe fn params_lower(&mut self, (_lower0,): Self::Params, _ptr: *mut u8) -> Self::ParamsLower {
    unsafe { let super::super::super::__with_name0::EntityId{ inner:inner0, } = _lower0;
    let vec1 = (inner0.into_bytes()).into_boxed_slice();
    let ptr1 = vec1.as_ptr().cast::<u8>();
    let len1 = vec1.len();
    ::core::mem::forget(vec1);
    ParamsLower(ptr1.cast_mut(), len1,) }
  }
  unsafe fn results_lift(&mut self, _ptr: *mut u8) -> Self::Results {
    unsafe { let l0 = *_ptr.add(0).cast::<i32>();

    super::super::super::igloo::lib::entity::Entity::from_handle(l0 as u32) }
  }
}
_MySubtask { _unused: core::marker::PhantomData }.call((id,)).await
}
}
  ...
  pub mod igloo {
    pub mod lib {
      ...
      pub mod core_to_extension_mp {
        ...
        pub unsafe fn _export_put_component_cabi<T: Guest>(arg0: i64,arg1: i32,arg2: ::core::mem::MaybeUninit::<u64>,arg3: i64,arg4: i64,) -> i32 { unsafe {#[cfg(target_arch="wasm32")]
        _rt::run_ctors_once();wit_bindgen::rt::async_support::start_task(async move {
          ...
          let result15 = &{
            ...
            let v14 = match arg1 {
              0 => {
                let e14 = arg2.assume_init() as i64;
                V14::Integer(e14)
              }
              1 => {
                let e14 = f64::from_bits(arg2.assume_init() as i64 as u64);
                V14::Float(e14)
              }
              2 => {
                let e14 = {
                  let len0 = arg3 as usize;
                  let bytes0 = _rt::Vec::from_raw_parts(arg2.as_ptr().cast::<*mut u8>().read().cast(), len0, len0);
              ...
              3 => {
                let e14 = _rt::bool_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::Bool(e14)
              }
              4 => {
                let e14 = super::super::super::super::__with_name1::IglooColor{
                  r: f64::from_bits(arg2.assume_init() as i64 as u64),
                  g: f64::from_bits(arg3 as u64),
                  b: f64::from_bits(arg4 as u64),
                };
                V14::Color(e14)
              }
              5 => {
                let e14 = super::super::super::super::__with_name1::IglooDate{
                  year: arg2.assume_init() as i64 as i32 as u16,
                  month: arg3 as i32 as u8,
                  day: arg4 as i32 as u8,
                };
                V14::Date(e14)
              }
              6 => {
                let e14 = super::super::super::super::__with_name1::IglooTime{
                  hour: arg2.assume_init() as i64 as i32 as u8,
                  minute: arg3 as i32 as u8,
                  second: arg4 as i32 as u8,
                };
                V14::Time(e14)
              }
              7 => {
                let e14 = {
                  ...
                  <_ as From<_rt::Vec<_>>>::from(_rt::Vec::from_raw_parts(arg2.as_ptr().cast::<*mut u8>().read().cast(), len1, len1))
                };
                V14::IntegerList(e14)
              }
              8 => {
                let e14 = {
                  ...
                  <_ as From<_rt::Vec<_>>>::from(_rt::Vec::from_raw_parts(arg2.as_ptr().cast::<*mut u8>().read().cast(), len2, len2))
                };
                V14::FloatList(e14)
              }
              9 => {
                let e14 = {
                  let base6 = arg2.as_ptr().cast::<*mut u8>().read();
              ...
              10 => {
                let e14 = {
                  let base8 = arg2.as_ptr().cast::<*mut u8>().read();
              ...
              11 => {
                let e14 = {
                  ...
                  <_ as From<_rt::Vec<_>>>::from(_rt::Vec::from_raw_parts(arg2.as_ptr().cast::<*mut u8>().read().cast(), len9, len9))
                };
                V14::ColorList(e14)
              }
              12 => {
                let e14 = {
                  ...
                  <_ as From<_rt::Vec<_>>>::from(_rt::Vec::from_raw_parts(arg2.as_ptr().cast::<*mut u8>().read().cast(), len10, len10))
                };
                V14::DateList(e14)
              }
              13 => {
                let e14 = {
                  ...
                  <_ as From<_rt::Vec<_>>>::from(_rt::Vec::from_raw_parts(arg2.as_ptr().cast::<*mut u8>().read().cast(), len11, len11))
                };
                V14::TimeList(e14)
              }
              14 => {
              ...
              17 => {
                let e14 = super::super::super::super::__with_name2::Weekday::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::Weekday(e14)
              }
              18 => {
                V14::Light
              ...
              22 => {
                let e14 = super::super::super::super::__with_name2::ColorMode::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::ColorMode(e14)
              }
              23 => {
                let e14 = arg2.assume_init() as i64;
              ...
              30 => {
                let e14 = {
                  ...
                  let bytes12 = _rt::Vec::from_raw_parts(arg2.as_ptr().cast::<*mut u8>().read().cast(), len12, len12);
              ...
              32 => {
                let e14 = {
                  ...
                  let bytes13 = _rt::Vec::from_raw_parts(arg2.as_ptr().cast::<*mut u8>().read().cast(), len13, len13);
              ...
              33 => {
                let e14 = super::super::super::super::__with_name2::SensorStateClass::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::SensorStateClass(e14)
              }
              34 => {
                let e14 = super::super::super::super::__with_name2::UnitApparentPower::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitApparentPower(e14)
              }
              35 => {
                let e14 = super::super::super::super::__with_name2::UnitPower::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitPower(e14)
              }
              36 => {
                let e14 = super::super::super::super::__with_name2::UnitReactivePower::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitReactivePower(e14)
              }
              37 => {
                let e14 = super::super::super::super::__with_name2::UnitEnergy::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitEnergy(e14)
              }
              38 => {
                let e14 = super::super::super::super::__with_name2::UnitElectricCurrent::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitElectricCurrent(e14)
              }
              39 => {
                let e14 = super::super::super::super::__with_name2::UnitElectricPotential::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitElectricPotential(e14)
              }
              40 => {
                let e14 = super::super::super::super::__with_name2::UnitDegree::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitDegree(e14)
              }
              41 => {
                let e14 = super::super::super::super::__with_name2::UnitCurrency::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitCurrency(e14)
              }
              42 => {
                let e14 = super::super::super::super::__with_name2::UnitTemperature::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitTemperature(e14)
              }
              43 => {
                let e14 = super::super::super::super::__with_name2::UnitTime::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitTime(e14)
              }
              44 => {
                let e14 = super::super::super::super::__with_name2::UnitLength::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitLength(e14)
              }
              45 => {
                let e14 = super::super::super::super::__with_name2::UnitFrequency::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitFrequency(e14)
              }
              46 => {
                let e14 = super::super::super::super::__with_name2::UnitPressure::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitPressure(e14)
              }
              47 => {
                let e14 = super::super::super::super::__with_name2::UnitSoundPressure::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitSoundPressure(e14)
              }
              48 => {
                let e14 = super::super::super::super::__with_name2::UnitVolume::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitVolume(e14)
              }
              49 => {
                let e14 = super::super::super::super::__with_name2::UnitVolumeFlowRate::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitVolumeFlowRate(e14)
              }
              50 => {
                let e14 = super::super::super::super::__with_name2::UnitArea::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitArea(e14)
              }
              51 => {
                let e14 = super::super::super::super::__with_name2::UnitMass::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitMass(e14)
              }
              52 => {
                let e14 = super::super::super::super::__with_name2::UnitConductivity::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitConductivity(e14)
              }
              53 => {
                let e14 = super::super::super::super::__with_name2::UnitLight::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitLight(e14)
              }
              54 => {
                let e14 = super::super::super::super::__with_name2::UnitUvIndex::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitUvIndex(e14)
              }
              55 => {
                let e14 = super::super::super::super::__with_name2::UnitPercentage::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitPercentage(e14)
              }
              56 => {
                let e14 = super::super::super::super::__with_name2::UnitIrradiation::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitIrradiation(e14)
              }
              57 => {
                let e14 = super::super::super::super::__with_name2::UnitConcentration::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitConcentration(e14)
              }
              58 => {
                let e14 = super::super::super::super::__with_name2::UnitSpeed::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitSpeed(e14)
              }
              59 => {
                let e14 = super::super::super::super::__with_name2::UnitData::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitData(e14)
              }
              60 => {
                let e14 = super::super::super::super::__with_name2::UnitDataRate::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::UnitDataRate(e14)
              }
              61 => {
                let e14 = super::super::super::super::__with_name2::FanOscillation::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::FanOscillation(e14)
              }
              62 => {
                let e14 = super::super::super::super::__with_name2::FanDirection::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::FanDirection(e14)
              }
              63 => {
                let e14 = super::super::super::super::__with_name2::FanSpeed::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::FanSpeed(e14)
              }
              64 => {
                let e14 = super::super::super::super::__with_name2::ClimateMode::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::ClimateMode(e14)
              }
              65 => {
                let e14 = super::super::super::super::__with_name2::LockState::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::LockState(e14)
              }
              66 => {
                let e14 = super::super::super::super::__with_name2::MediaState::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::MediaState(e14)
              }
              67 => {
                V14::Cover
              ...
              68 => {
                let e14 = super::super::super::super::__with_name2::CoverState::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::CoverState(e14)
              }
              69 => {
                let e14 = f64::from_bits(arg2.assume_init() as i64 as u64);
              ...
              72 => {
                let e14 = super::super::super::super::__with_name2::ValveState::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::ValveState(e14)
              }
              n => {
                debug_assert_eq!(n, 73, "invalid enum discriminant");
                let e14 = super::super::super::super::__with_name2::AlarmState::_lift(arg2.assume_init() as i64 as i32 as u8);
                V14::AlarmState(e14)
              }
            };
            T::put_component(super::super::super::super::__with_name0::EntityIndex{
              inner: arg0 as u64,
            }, v14).await
          };
          ...
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "[export]igloo:lib/core-to-extension-mp@0.1.0")]
          unsafe extern "C" {
    ...
    pub trait Guest {
      ...
      #[allow(async_fn_in_trait)]
      async fn put_component(entity_index: EntityIndex,component: Component,) -> Result<(),_rt::String>;
    ...
    macro_rules! __export_igloo_lib_core_to_extension_mp_0_1_0_cabi{
      ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

        #[unsafe(export_name = "[async-lift]igloo:lib/core-to-extension-mp@0.1.0#put-component")]
        unsafe extern "C" fn export_put_component(arg0: i64,arg1: i32,arg2: ::core::mem::MaybeUninit::<u64>,arg3: i64,arg4: i64,) -> i32 {
          unsafe { $($path_to_types)*::_export_put_component_cabi::<$ty>(arg0, arg1, arg2, arg3, arg4) }
        }
        #[unsafe(export_name = "[callback][async-lift]igloo:lib/core-to-extension-mp@0.1.0#put-component")]
        ...
        #[unsafe(export_name = "[async-lift]igloo:lib/core-to-extension-mp@0.1.0#custom")]
        ...
        #[unsafe(export_name = "[callback][async-lift]igloo:lib/core-to-extension-mp@0.1.0#custom")]
    ...
    #[doc(hidden)]
    pub(crate) use __export_igloo_lib_core_to_extension_mp_0_1_0_cabi;
...
macro_rules! __export_extension_mp_impl {
  ($ty:ident) => (self::export!($ty with_types_in self););
  ($ty:ident with_types_in $($path_to_types_root:tt)*) => (
  $($path_to_types_root)*::exports::igloo::lib::core_to_extension_mp::__export_igloo_lib_core_to_extension_mp_0_1_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::igloo::lib::core_to_extension_mp);
...
#[doc(inline)]
pub(crate) use __export_extension_mp_impl as export;

#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.52.0:igloo:lib@0.1.0:extension-mp:encoded world")]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 13253] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xc2f\x01A\x02\x01AG\x01\
...
\x03\0\x03\x06entity\x01B\x14\x02\x03\x02\x01\x0a\x04\0\x09device-id\x03\0\0\x02\
\x03\x02\x01\x06\x04\0\x09entity-id\x03\0\x02\x02\x03\x02\x01\x08\x04\0\x09compo\
nent\x03\0\x04\x02\x03\x02\x01\x0b\x04\0\x06entity\x03\0\x06\x01@\0\0\x01\x04\0\x02\
id\x01\x08\x01ks\x01C\x01\x03keys\0\x09\x04\0\x07get-cfg\x01\x0a\x01C\x02\x03key\
s\x05values\x01\0\x04\0\x08save-cfg\x01\x0b\x01C\x01\x03keys\x01\0\x04\0\x0aremo\
ve-cfg\x01\x0c\x01i\x07\x01C\x01\x02id\x03\0\x0d\x04\0\x0fregister-entity\x01\x0e\
\x03\0%igloo:lib/extension-mp-to-igloo@0.1.0\x05\x0c\x01B\x0a\x01o\x02ss\x01p\0\x01\
@\0\0\x01\x04\0\x0fget-environment\x01\x02\x01ps\x01@\0\0\x03\x04\0\x0dget-argum\
ents\x01\x04\x01ks\x01@\0\0\x05\x04\0\x0fget-initial-cwd\x01\x06\x03\0(wasi:cli/\
environment@0.3.0-rc-2026-01-06\x05\x0d\x01B\x03\x01j\0\0\x01@\x01\x06status\0\x01\
\0\x04\0\x04exit\x01\x01\x03\0!wasi:cli/exit@0.3.0-rc-2026-01-06\x05\x0e\x01B\x02\
\x01m\x03\x02io\x15illegal-byte-sequence\x04pipe\x04\0\x0aerror-code\x03\0\0\x03\
\0\"wasi:cli/types@0.3.0-rc-2026-01-06\x05\x0f\x02\x03\0\x07\x0aerror-code\x01B\x08\
\x02\x03\x02\x01\x10\x04\0\x0aerror-code\x03\0\0\x01f\x01}\x01j\0\x01\x01\x01e\x01\
\x03\x01o\x02\x02\x04\x01@\0\0\x05\x04\0\x0fread-via-stream\x01\x06\x03\0\"wasi:\
cli/stdin@0.3.0-rc-2026-01-06\x05\x11\x01B\x06\x02\x03\x02\x01\x10\x04\0\x0aerro\
r-code\x03\0\0\x01f\x01}\x01j\0\x01\x01\x01C\x01\x04data\x02\0\x03\x04\0\x10writ\
e-via-stream\x01\x04\x03\0#wasi:cli/stdout@0.3.0-rc-2026-01-06\x05\x12\x01B\x06\x02\
\x03\x02\x01\x10\x04\0\x0aerror-code\x03\0\0\x01f\x01}\x01j\0\x01\x01\x01C\x01\x04\
data\x02\0\x03\x04\0\x10write-via-stream\x01\x04\x03\0#wasi:cli/stderr@0.3.0-rc-\
2026-01-06\x05\x13\x01B\x01\x04\0\x0eterminal-input\x03\x01\x03\0+wasi:cli/termi\
nal-input@0.3.0-rc-2026-01-06\x05\x14\x01B\x01\x04\0\x0fterminal-output\x03\x01\x03\
\0,wasi:cli/terminal-output@0.3.0-rc-2026-01-06\x05\x15\x02\x03\0\x0b\x0etermina\
l-input\x01B\x06\x02\x03\x02\x01\x16\x04\0\x0eterminal-input\x03\0\0\x01i\x01\x01\
k\x02\x01@\0\0\x03\x04\0\x12get-terminal-stdin\x01\x04\x03\0+wasi:cli/terminal-s\
tdin@0.3.0-rc-2026-01-06\x05\x17\x02\x03\0\x0c\x0fterminal-output\x01B\x06\x02\x03\
\x02\x01\x18\x04\0\x0fterminal-output\x03\0\0\x01i\x01\x01k\x02\x01@\0\0\x03\x04\
\0\x13get-terminal-stdout\x01\x04\x03\0,wasi:cli/terminal-stdout@0.3.0-rc-2026-0\
1-06\x05\x19\x01B\x06\x02\x03\x02\x01\x18\x04\0\x0fterminal-output\x03\0\0\x01i\x01\
\x01k\x02\x01@\0\0\x03\x04\0\x13get-terminal-stderr\x01\x04\x03\0,wasi:cli/termi\
nal-stderr@0.3.0-rc-2026-01-06\x05\x1a\x01B\x02\x01w\x04\0\x08duration\x03\0\0\x03\
\0%wasi:clocks/types@0.3.0-rc-2026-01-06\x05\x1b\x02\x03\0\x10\x08duration\x01B\x0c\
\x02\x03\x02\x01\x1c\x04\0\x08duration\x03\0\0\x01w\x04\0\x04mark\x03\0\x02\x01@\
\0\0\x03\x04\0\x03now\x01\x04\x01@\0\0\x01\x04\0\x0eget-resolution\x01\x05\x01C\x01\
\x04when\x03\x01\0\x04\0\x0await-until\x01\x06\x01C\x01\x08how-long\x01\x01\0\x04\
\0\x08wait-for\x01\x07\x03\0/wasi:clocks/monotonic-clock@0.3.0-rc-2026-01-06\x05\
\x1d\x01B\x08\x02\x03\x02\x01\x1c\x04\0\x08duration\x03\0\0\x01r\x02\x07secondsx\
\x0bnanosecondsy\x04\0\x07instant\x03\0\x02\x01@\0\0\x03\x04\0\x03now\x01\x04\x01\
@\0\0\x01\x04\0\x0eget-resolution\x01\x05\x03\0,wasi:clocks/system-clock@0.3.0-r\
c-2026-01-06\x05\x1e\x02\x03\0\x12\x07instant\x01BY\x02\x03\x02\x01\x1f\x04\0\x07\
instant\x03\0\0\x01w\x04\0\x08filesize\x03\0\x02\x01m\x08\x07unknown\x0cblock-de\
vice\x10character-device\x09directory\x04fifo\x0dsymbolic-link\x0cregular-file\x06\
socket\x04\0\x0fdescriptor-type\x03\0\x04\x01n\x06\x04read\x05write\x13file-inte\
grity-sync\x13data-integrity-sync\x14requested-write-sync\x10mutate-directory\x04\
\0\x10descriptor-flags\x03\0\x06\x01n\x01\x0esymlink-follow\x04\0\x0apath-flags\x03\
\0\x08\x01n\x04\x06create\x09directory\x09exclusive\x08truncate\x04\0\x0aopen-fl\
ags\x03\0\x0a\x01w\x04\0\x0alink-count\x03\0\x0c\x01k\x01\x01r\x06\x04type\x05\x0a\
link-count\x0d\x04size\x03\x15data-access-timestamp\x0e\x1bdata-modification-tim\
estamp\x0e\x17status-change-timestamp\x0e\x04\0\x0fdescriptor-stat\x03\0\x0f\x01\
q\x03\x09no-change\0\0\x03now\0\0\x09timestamp\x01\x01\0\x04\0\x0dnew-timestamp\x03\
\0\x11\x01r\x02\x04type\x05\x04names\x04\0\x0fdirectory-entry\x03\0\x13\x01m$\x06\
access\x07already\x0ebad-descriptor\x04busy\x08deadlock\x05quota\x05exist\x0efil\
e-too-large\x15illegal-byte-sequence\x0bin-progress\x0binterrupted\x07invalid\x02\
...
26-01-06\x05\x20\x02\x03\0\x13\x0adescriptor\x01B\x07\x02\x03\x02\x01!\x04\0\x0a\
descriptor\x03\0\0\x01i\x01\x01o\x02\x02s\x01p\x03\x01@\0\0\x04\x04\0\x0fget-dir\
ectories\x01\x05\x03\0,wasi:filesystem/preopens@0.3.0-rc-2026-01-06\x05\"\x01Bq\x02\
\x03\x02\x01\x1c\x04\0\x08duration\x03\0\0\x01m\x0e\x07unknown\x0daccess-denied\x0d\
not-supported\x10invalid-argument\x0dout-of-memory\x07timeout\x0dinvalid-state\x14\
address-not-bindable\x0eaddress-in-use\x12remote-unreachable\x12connection-refus\
ed\x10connection-reset\x12connection-aborted\x12datagram-too-large\x04\0\x0aerro\
r-code\x03\0\x02\x01m\x02\x04ipv4\x04ipv6\x04\0\x11ip-address-family\x03\0\x04\x01\
o\x04}}}}\x04\0\x0cipv4-address\x03\0\x06\x01o\x08{{{{{{{{\x04\0\x0cipv6-address\
\x03\0\x08\x01q\x02\x04ipv4\x01\x07\0\x04ipv6\x01\x09\0\x04\0\x0aip-address\x03\0\
\x0a\x01r\x02\x04port{\x07address\x07\x04\0\x13ipv4-socket-address\x03\0\x0c\x01\
r\x04\x04port{\x09flow-infoy\x07address\x09\x08scope-idy\x04\0\x13ipv6-socket-ad\
dress\x03\0\x0e\x01q\x02\x04ipv4\x01\x0d\0\x04ipv6\x01\x0f\0\x04\0\x11ip-socket-\
address\x03\0\x10\x04\0\x0atcp-socket\x03\x01\x04\0\x0audp-socket\x03\x01\x01i\x12\
\x01j\x01\x14\x01\x03\x01@\x01\x0eaddress-family\x05\0\x15\x04\0\x19[static]tcp-\
socket.create\x01\x16\x01h\x12\x01j\0\x01\x03\x01@\x02\x04self\x17\x0dlocal-addr\
ess\x11\0\x18\x04\0\x17[method]tcp-socket.bind\x01\x19\x01C\x02\x04self\x17\x0er\
emote-address\x11\0\x18\x04\0\x1a[method]tcp-socket.connect\x01\x1a\x01f\x01\x14\
\x01j\x01\x1b\x01\x03\x01@\x01\x04self\x17\0\x1c\x04\0\x19[method]tcp-socket.lis\
ten\x01\x1d\x01f\x01}\x01C\x02\x04self\x17\x04data\x1e\0\x18\x04\0\x17[method]tc\
p-socket.send\x01\x1f\x01e\x01\x18\x01o\x02\x1e\x20\x01@\x01\x04self\x17\0!\x04\0\
\x1a[method]tcp-socket.receive\x01\"\x01j\x01\x11\x01\x03\x01@\x01\x04self\x17\0\
#\x04\0$[method]tcp-socket.get-local-address\x01$\x04\0%[method]tcp-socket.get-r\
emote-address\x01$\x01@\x01\x04self\x17\0\x7f\x04\0#[method]tcp-socket.get-is-li\
stening\x01%\x01@\x01\x04self\x17\0\x05\x04\0%[method]tcp-socket.get-address-fam\
ily\x01&\x01@\x02\x04self\x17\x05valuew\0\x18\x04\0*[method]tcp-socket.set-liste\
n-backlog-size\x01'\x01j\x01\x7f\x01\x03\x01@\x01\x04self\x17\0(\x04\0)[method]t\
cp-socket.get-keep-alive-enabled\x01)\x01@\x02\x04self\x17\x05value\x7f\0\x18\x04\
\0)[method]tcp-socket.set-keep-alive-enabled\x01*\x01j\x01\x01\x01\x03\x01@\x01\x04\
self\x17\0+\x04\0+[method]tcp-socket.get-keep-alive-idle-time\x01,\x01@\x02\x04s\
elf\x17\x05value\x01\0\x18\x04\0+[method]tcp-socket.set-keep-alive-idle-time\x01\
-\x04\0*[method]tcp-socket.get-keep-alive-interval\x01,\x04\0*[method]tcp-socket\
.set-keep-alive-interval\x01-\x01j\x01y\x01\x03\x01@\x01\x04self\x17\0.\x04\0'[m\
ethod]tcp-socket.get-keep-alive-count\x01/\x01@\x02\x04self\x17\x05valuey\0\x18\x04\
\0'[method]tcp-socket.set-keep-alive-count\x010\x01j\x01}\x01\x03\x01@\x01\x04se\
lf\x17\01\x04\0\x20[method]tcp-socket.get-hop-limit\x012\x01@\x02\x04self\x17\x05\
value}\0\x18\x04\0\x20[method]tcp-socket.set-hop-limit\x013\x01j\x01w\x01\x03\x01\
@\x01\x04self\x17\04\x04\0*[method]tcp-socket.get-receive-buffer-size\x015\x04\0\
*[method]tcp-socket.set-receive-buffer-size\x01'\x04\0'[method]tcp-socket.get-se\
nd-buffer-size\x015\x04\0'[method]tcp-socket.set-send-buffer-size\x01'\x01i\x13\x01\
j\x016\x01\x03\x01@\x01\x0eaddress-family\x05\07\x04\0\x19[static]udp-socket.cre\
ate\x018\x01h\x13\x01@\x02\x04self9\x0dlocal-address\x11\0\x18\x04\0\x17[method]\
udp-socket.bind\x01:\x01@\x02\x04self9\x0eremote-address\x11\0\x18\x04\0\x1a[met\
hod]udp-socket.connect\x01;\x01@\x01\x04self9\0\x18\x04\0\x1d[method]udp-socket.\
disconnect\x01<\x01p}\x01k\x11\x01C\x03\x04self9\x04data=\x0eremote-address>\0\x18\
\x04\0\x17[method]udp-socket.send\x01?\x01o\x02=\x11\x01j\x01\xc0\0\x01\x03\x01C\
\x01\x04self9\0\xc1\0\x04\0\x1a[method]udp-socket.receive\x01B\x01@\x01\x04self9\
\0#\x04\0$[method]udp-socket.get-local-address\x01C\x04\0%[method]udp-socket.get\
-remote-address\x01C\x01@\x01\x04self9\0\x05\x04\0%[method]udp-socket.get-addres\
s-family\x01D\x01@\x01\x04self9\01\x04\0([method]udp-socket.get-unicast-hop-limi\
t\x01E\x01@\x02\x04self9\x05value}\0\x18\x04\0([method]udp-socket.set-unicast-ho\
p-limit\x01F\x01@\x01\x04self9\04\x04\0*[method]udp-socket.get-receive-buffer-si\
ze\x01G\x01@\x02\x04self9\x05valuew\0\x18\x04\0*[method]udp-socket.set-receive-b\
uffer-size\x01H\x04\0'[method]udp-socket.get-send-buffer-size\x01G\x04\0'[method\
]udp-socket.set-send-buffer-size\x01H\x03\0&wasi:sockets/types@0.3.0-rc-2026-01-\
06\x05#\x02\x03\0\x15\x0aip-address\x01B\x08\x02\x03\x02\x01$\x04\0\x0aip-addres\
s\x03\0\0\x01m\x06\x07unknown\x0daccess-denied\x10invalid-argument\x11name-unres\
olvable\x1atemporary-resolver-failure\x1apermanent-resolver-failure\x04\0\x0aerr\
or-code\x03\0\x02\x01p\x01\x01j\x01\x04\x01\x03\x01C\x01\x04names\0\x05\x04\0\x11\
resolve-addresses\x01\x06\x03\0/wasi:sockets/ip-name-lookup@0.3.0-rc-2026-01-06\x05\
%\x01B\x05\x01p}\x01@\x01\x03lenw\0\0\x04\0\x10get-random-bytes\x01\x01\x01@\0\0\
w\x04\0\x0eget-random-u64\x01\x02\x03\0&wasi:random/random@0.3.0-rc-2026-01-06\x05\
&\x01B\x05\x01p}\x01@\x01\x03lenw\0\0\x04\0\x19get-insecure-random-bytes\x01\x01\
\x01@\0\0w\x04\0\x17get-insecure-random-u64\x01\x02\x03\0(wasi:random/insecure@0\
.3.0-rc-2026-01-06\x05'\x01B\x03\x01o\x02ww\x01@\0\0\0\x04\0\x11get-insecure-see\
d\x01\x01\x03\0-wasi:random/insecure-seed@0.3.0-rc-2026-01-06\x05(\x01B\x09\x02\x03\
\x02\x01\x07\x04\0\x0centity-index\x03\0\0\x02\x03\x02\x01\x08\x04\0\x09componen\
t\x03\0\x02\x01j\0\x01s\x01C\x02\x0centity-index\x01\x09component\x03\0\x04\x04\0\
\x0dput-component\x01\x05\x01C\x02\x04names\x06paramss\0\x04\x04\0\x06custom\x01\
\x06\x04\0$igloo:lib/core-to-extension-mp@0.1.0\x05)\x01B\x03\x01j\0\0\x01C\0\0\0\
\x04\0\x03run\x01\x01\x04\0\x20wasi:cli/run@0.3.0-rc-2026-01-06\x05*\x04\0\x1cig\
loo:lib/extension-mp@0.1.0\x04\0\x0b\x12\x01\0\x0cextension-mp\x03\0\0\0G\x09pro\
ducers\x01\x0cprocessed-by\x02\x0dwit-component\x070.244.0\x10wit-bindgen-rust\x06\
0.52.0";
