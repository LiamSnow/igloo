...
pub mod igloo {
  pub mod lib {
    ...
    pub mod extension_mp_to_igloo {
      ...
      #[allow(async_fn_in_trait)]
      pub fn register_entity(id: &EntityId,) -> Entity{
        unsafe {
          ...
          #[link(wasm_import_module = "igloo:lib/extension-mp-to-igloo@0.1.0")]
          unsafe extern "C" {
            #[link_name = "register-entity"]
            fn wit_import2(_: *mut u8, _: usize, ) -> i32;
          }

          #[cfg(not(target_arch = "wasm32"))]
          unsafe extern "C" fn wit_import2(_: *mut u8, _: usize, ) -> i32 { unreachable!() }
          let ret = wit_import2(ptr1.cast_mut(), len1);
          super::super::super::igloo::lib::entity::Entity::from_handle(ret as u32)
        }
      }
  ...
  pub mod igloo {
    pub mod lib {
      ...
      pub mod core_to_extension_mp {
        ...
        pub unsafe fn _export_put_component_cabi<T: Guest>(arg0: i64,arg1: i32,arg2: ::core::mem::MaybeUninit::<u64>,arg3: i64,arg4: i64,) -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
    ...
    pub trait Guest {
      ...
      #[allow(async_fn_in_trait)]
      fn put_component(entity_index: EntityIndex,component: Component,) -> Result<(),_rt::String>;
    ...
    macro_rules! __export_igloo_lib_core_to_extension_mp_0_1_0_cabi{
      ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
        ...
        #[unsafe(export_name = "igloo:lib/core-to-extension-mp@0.1.0#put-component")]
        unsafe extern "C" fn export_put_component(arg0: i64,arg1: i32,arg2: ::core::mem::MaybeUninit::<u64>,arg3: i64,arg4: i64,) -> *mut u8 {
          unsafe { $($path_to_types)*::_export_put_component_cabi::<$ty>(arg0, arg1, arg2, arg3, arg4) }
        }
        #[unsafe(export_name = "cabi_post_igloo:lib/core-to-extension-mp@0.1.0#put-component")]
        unsafe extern "C" fn _post_return_put_component(arg0: *mut u8,) {
          unsafe { $($path_to_types)*::__post_return_put_component::<$ty>(arg0) }
        }
        #[unsafe(export_name = "igloo:lib/core-to-extension-mp@0.1.0#custom")]
        ...
        #[unsafe(export_name = "cabi_post_igloo:lib/core-to-extension-mp@0.1.0#custom")]
