...
#[derive(Default, Serialize, Deserialize)]
pub struct Entity(Vec<ComponentValue>);
...
#[derive(Serialize, Deserialize)]
pub struct StringComponent(String);

#[derive(Serialize, Deserialize)]
pub struct Object(HashMap<String, ComponentValue>);

#[derive(Serialize, Deserialize)]
pub struct List(Vec<ComponentValue>);
