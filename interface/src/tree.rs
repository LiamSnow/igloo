...
#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct Object(pub HashMap<String, Component>);
...
#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct FloatMin(f64);
/// usually used in combination with a Float to set a range
#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct FloatMax(f64);
/// usually used in combination with a Float to set a range
#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct FloatStep(f64);

/// usually used in combination with an Int to set a range
#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct IntMin(i32);
/// usually used in combination with an Int to set a range
#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct IntMax(i32);
/// usually used in combination with an Int to set a range
#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct IntStep(i32);

/// usually used in combination with an Long to set a range
#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct LongMin(i64);
/// usually used in combination with an Long to set a range
#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct LongMax(i64);
/// usually used in combination with an Long to set a range
#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct LongStep(i64);

/// usually used in combination with an Uint to set a range
#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct UintMin(u32);
/// usually used in combination with an Uint to set a range
#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct UintMax(u32);
/// usually used in combination with an Uint to set a range
#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct UintStep(u32);
